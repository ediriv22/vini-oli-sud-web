        ...
        <div className="border-t border-[rgba(200,167,111,0.36)] py-6 sm:py-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.12fr)_minmax(0,0.88fr)] lg:items-start">
            <div>
              ...
              {/*
                Fix mobile: clamp ridotto da (3rem,10vw,4.8rem) a (2rem,7vw,4.8rem)
                max-w allargato da 10ch a 20ch — evita il wrapping parola per parola
                display-balance mantenuto per desktop dove funziona bene
              */}
